...
<div class="w-screen min-h-screen bg-gradient-to-b from-[#53483B] via-[#605c56] to-[#817e7b] mx-auto px-4 py-12 ">
    <h1 class="text-4xl font-bold text-center max-sm:my-8 sm:mt-20 mb-10 title text-white">Product Catalogue</h1>

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-[80%] mx-auto">
